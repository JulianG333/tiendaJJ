...
class Order(models.Model):
    ...
    shopping_total = models.DecimalField(default=5, max_digits=8, decimal_places=2)
    ...
    def get_total(self):
        return self.cart.total + self.shopping_total - decimal.Decimal(self.get_discount())
